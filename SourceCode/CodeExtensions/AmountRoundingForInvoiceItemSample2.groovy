...
public class AmountRoundingForInvoiceItemSample2 extends AbstractEntityLifecycleInterceptor {
    @Override
	...
	return itemAmount;
        ...
        roundedValue = ConversionUtils.convertNumberToDouble(getUserContext(), itemAmount, expectedFractionalDigits, expectedRoundingMethod);
        /**
         * Method - 2
         */
        // Custom rounding - rule provided by HIT
        long amountWithoutDecimal = itemAmount.longValue();
