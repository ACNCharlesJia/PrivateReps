...
import com.navis.billing.business.model.BillingSequenceProvider;
import com.navis.billing.business.model.Credit;
import com.navis.billing.business.model.CreditItem;
import com.navis.billing.business.model.CreditItemTax;
import com.navis.billing.business.model.CreditManagerImpl;
...
class MTLN4BillingACRHandlerCore extends GroovyApi {
        ...
        for (InvoiceItem invoiceItem : invoiceItems) {
            if (invoiceItem != null) {
                ...
                if (hasCredits(invoiceItem)) {
                    ...
                    createPartialCredit(credit, invoiceItem);
                } else {
    ...
    public boolean hasCredits(InvoiceItem inInvoiceItem) {
